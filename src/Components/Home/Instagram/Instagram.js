  ...
  return (<>
    <section id="instagram">
      ...
      <MediaQuery minWidth={992}>
        ...
        {/* <Container>
          <Row className="portfolio text-light">
            {insta && insta?.data.map((item, index) => {
              if (item?.media_type === "IMAGE") {
                console.log(item?.permalink, "items")
                return (
                  <React.Fragment key={`item-${index}`}>
                    <Col lg={4} md={4} className="me-1 mb-1">
                      <a href={item?.media_url}>
                        <img className='me-1 shadowInsta' src={item?.permalink} alt="ask " />
                      </a>
                    </Col>
                  </React.Fragment>
                )
