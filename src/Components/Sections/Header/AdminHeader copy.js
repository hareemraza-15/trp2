        ...
        <div className="d-flex justify-content-between align-items-center">
            ...
            <nav id="navbar" className="navbar mx-2">
              <ul className="links">
                <li onClick={() => goToHomePage()}>
                  ...
                  <a
                    style={{ fontSize: "20px" }}
                    className="link-item nav-link scrollto"
                  >
                    {" "}
                    Home{" "}
                  </a>{" "}
          ...
          <MediaQuery minWidth={801} maxWidth={875}>
            ...
            <nav
              id="navbar"
              className="navbar"
              style={{ margin: "2px", paddingLeft: "2px" }}
            >
              <ul className="links">
                <li
                ...
                <li onClick={() => goToShop()} style={{ paddingLeft: "0px" }}>
                  {" "}
                  <a
                ...
                <li onClick={() => goToAbout()} style={{ paddingLeft: "0px" }}>
                  {" "}
                  <a
                    style={{ fontSize: "0.85rem" }}
                    className="link-item nav-link scrollto"
          ...
          <MediaQuery minWidth={876} maxWidth={950}>
            ...
            >
              <ul className="links">
                ...
                <li style={{ paddingLeft: "0px" }} onClick={() => goToShop()}>
                  {" "}
                  <a
                    style={{ fontSize: "1rem" }}
                    className="link-item nav-link scrollto"
