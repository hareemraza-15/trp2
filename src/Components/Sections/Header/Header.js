...
import { Button, Modal, Card, Stack } from 'react-bootstrap';
      ...
      <div className="d-flex align-items-center">
        ...
        <MediaQuery minWidth={1200}>
          ...
          <nav id="navbar" className="navbar mx-2" >
            ...
            <Stack direction='horizontal' gap={2}>
              <Search className='mx-1' size={28} />
              <Bag onClick={() => setEditModal(true)} className='mx-1' size={28} />
              <Heart onClick={() => goToWishList()} className='mx-1' size={28} />
        ...
        <MediaQuery minWidth={1035} maxWidth={1199}>
          ...
          <nav id="navbar" className="navbar mx-2" >
            ...
            <Stack direction='horizontal' gap={2}>
              {/* <Person className=' mx-1' color='black' size={20} /> */}
              <Search className='mx-1' size={20} />
              <Bag onClick={() => setEditModal(true)} className='mx-1' size={20} />
              <Heart onClick={() => goToWishList()} className='mx-1' size={20} />
              <PersonCircle onClick={() => setProfileModal(true)} className='mx-1' size={20} />
            </Stack>
          </nav>
        </MediaQuery>
