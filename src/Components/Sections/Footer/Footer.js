            ...
            <div className="row">
              <div className="col-lg-4 col-md-4 col-sm-6 text-start">
                ...
                <ul>
                  <li style={{ fontSize: "16px" }}>
                    <NavLink style={{ textDecoration: 'none' }} to={`/shop/about`}>
                      About us
                    </NavLink>
                  </li>
                  <li style={{ fontSize: "16px" }}>
                    <NavLink style={{ textDecoration: 'none' }} to={`/shop/contact`}>
                      Contact us
                    </NavLink>
                  </li>
                  <li style={{ fontSize: "16px" }}>
                    <NavLink style={{ textDecoration: 'none' }} to={`/shop/terms`}>
                      Terms and Conditions
                    </NavLink>
                  </li>
                  <li style={{ fontSize: "16px" }}>
                    <NavLink style={{ textDecoration: 'none' }} to={`/shop/privacy`}>
                      Privacy Policy
                    </NavLink>
                  </li>
                </ul>
              ...
              <div className="col-lg-4 col-md-4 col-sm-6 text-start">
                ...
                <ul>
                  ...
                  <li style={{ fontSize: "16px" }}>
                    <NavLink style={{ textDecoration: 'none' }} to={`/#new-arrivals`}>
                      New Arrivals
                    </NavLink>
                  </li>
                  <li style={{ fontSize: "16px" }}>
                    <NavLink style={{ textDecoration: 'none' }} to={`/shop/help-center`}>
                      Help Center
                    </NavLink>
                  </li>
                </ul>
              ...
              <div className="col-lg-4 col-md-4 col-sm-6">
                ...
                <br />
                <div style={{ border: "1px solid white", borderRadius: "3px", cursor: 'pointer' }} className='pb-1 d-flex flex-wrap'>
                  <span className='ms-1 me-0'>  <Envelope color='white' size={20} className='mx-0 px-0' /> </span>
                  <input type="email" placeholder="Enter Your Email here" className='pe-2' style={{ cursor: 'pointer' }} />
                </div>
            ...
            <div style={{ backgroundColor: "black", color: "white" }} id="collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div style={{ backgroundColor: "black", color: "white", listStyle: "none" }} className="accordion-body">
                <ul style={{ listStyle: "none", color: "white", fontSize: "20px", fontWeight: "600" }} className='text-white'>
                  ...
                  <li className='my-2'>
                    <NavLink style={{ textDecoration: 'none', color: "white" }} to={`/#new-arrivals`}>
                      New Arrivals
                    </NavLink>
                  </li>
                  <li className='my-2'>
                    <NavLink style={{ textDecoration: 'none', color: "white" }} to={`/shop/help-center`}>
                      Help Center
                    </NavLink>
                  </li>
                </ul>
          ...
          <div style={{ backgroundColor: "black", color: "white", border: "2px solid black" }} className="accordion-item pb-0">
            ...
            <div style={{ backgroundColor: "black", color: "white" }} id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div style={{ backgroundColor: "black", color: "white" }} className="accordion-body">
                ...
                <div className='pb-1 mb-3 mx-3' style={{ cursor: 'pointer' }}>
                  <span className='mx-1'>  <Envelope color='white' size={20} /> </span>
                  <input type="email" placeholder="Enter Your Email here" style={{ cursor: 'pointer' }} />
                </div>
                <br />
